...
const Card = ({ imgProps, titleProps, contentProps, linkProps }) => {
    return (
        <>
        <div className='w-full  rounded-xl  backdrop-blur-2xl bg-tertiaryColor dark:bg-tertiaryColor/5 flex flex-col gap-5 overflow-hidden shadow-customshadow' data-aos = "fade-in">
            <ImageField src={imgProps} alt="error-icon" className=" object-cover  h-72"/>
