...
const Navbar = () => {
  ...
  return (
    <>
      <div className={`w-screen px-3 lg:px-4 h-20  lg:h-24 flex  justify-between items-center fixed top-0 left-0  bg-lightteriaryColor  dark:bg-mainbg z-50 ${scrolled ? "shadow-lg dark:shadow-white/5 !bg-tertiaryColor dark:!bg-mainbg" : ""} `} >
